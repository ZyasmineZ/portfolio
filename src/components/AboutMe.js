  ...
  return (
      <div className="about-container" id={id}>
        <div className="aboutMe-text">
          <h3>Hey there, 👋</h3>
          I'm <span> Yasmine </span>, a final year student pursuing <span>AI and Data Science </span> from Morocco. with a passion for technology and innovation. Throughout my academic journey, I have developed a strong foundation in artificial intelligence and data science, complemented by hands-on experience in development and app design.  I have successfully created several AI models as part of my coursework, showcasing my ability to apply theoretical knowledge to practical projects.  I'm all ears for <span>new opportunities</span> to create awesome software solutions.
          <br></br>
          <br></br>
