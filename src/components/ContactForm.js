...
import cartoon from '../images/pixel2.png';
...
export default function ContactForm({ id }) {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_8bqtgeg', 'template_22qdoph', form.current, 'N-O76bcAGVYk6v8n5')
      .then((result) => {
  ...
  return (
    <div className='contact-window' id={id}>
      ...
      <div className="contact-container">
        <img src={cartoon} alt='Yasmine' className="contact-wrapper-left"></img>        
